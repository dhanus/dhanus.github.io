...
<div class="post">
      ...
      <p>I am a startup founder, and I use this blog as a time saving device. If I spend  an hour (or more) advising or training someone, I turn my thoughts into a blog post. I hope you find it useful.</p>

      <p>I am on leave from a PhD at <a href="http://www.seas.harvard.edu">Harvard. As an NSF Fellow, I studied <a href="https://en.wikipedia.org/wiki/Machine_learning">machine learning</a> while advised by <a href="https://www.seas.harvard.edu/directory/finale">Finale Doshi</a> and <a href="https://www.seas.harvard.edu/directory/rpa">Ryan Adams</a>.</p>
